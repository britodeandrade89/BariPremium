...
export const Icons = {
  ...
  Droplet: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 22a7 7 0 0 0 7-7c0-2-2-3.9-7-11.5C7.1 11.1 5 13 5 15a7 7 0 0 0 7 7z"/></svg>
  ),
  ...
  Soup: ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 21a9 9 0 0 0 9-9H3a9 9 0 0 0 9 9Z"/><path d="M7 21h10"/><path d="M12 6V2"/><path d="M16 6V4"/><path d="M8 6V4"/></svg>
  ),
...
export const getIcon = (name: string, className?: string) => {
  switch (name) {
    ...
    case 'utensils': return <Icons.Utensils className={className} />;
    case 'tea': return <Icons.Tea className={className} />;
    case 'apple': return <Icons.Apple className={className} />;
    case 'soup': return <Icons.Soup className={className} />;
    case 'moon': return <Icons.Moon className={className} />;
    case 'check': return <Icons.Check className={className} />;
    default: return <Icons.Pill className={className} />;
  }
};